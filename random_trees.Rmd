...
# Adding randomness to basic_deterministic_trees()
...
# Exploring effects of "random_angles = T" and "random_lengths" with default "angle_variance"

### Default values

<b>angle_variance <- (angles[2]/4)^2</b> : angle of first split divided by 4 and squared <br>
<b>length_variance <- lengths[1]/24</b> : length of the starting branch divided by 24 <br>
